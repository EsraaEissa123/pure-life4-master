...
export default {
  ...
  created() {
    axios
      .get("http://deploy.purelife-erp.com/api/listlocation")
      .then((response) => {
        this.locations = response.data.data;
      });
    axios
      .get("http://deploy.purelife-erp.com/api/listdept")
      .then((response) => {
        this.departments = response.data.data;
      });
    axios
      .get("http://deploy.purelife-erp.com/api/listposition")
      .then((response) => {
  ...
  methods: {
    ...
    submiteOrClose() {
      ...
      axios
        .post(
          `http://deploy.purelife-erp.com/api/editemployee/${this.userEdit.id}`,
          this.userEdit,
          this.location_id,
          this.department_id,
          this.position_id
